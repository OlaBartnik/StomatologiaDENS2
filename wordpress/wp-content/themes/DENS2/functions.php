...
function noma_blank_header_scripts()
{
	...
	if (!is_admin()) {
		...
		wp_register_script('mapbox', 'https://api.mapbox.com/mapbox-gl-js/v1.8.0/mapbox-gl.js', array(), '1.0.0', true);
...
function custome_styles()
{
	...
	wp_register_style('mapboxStyle', 'https://api.mapbox.com/mapbox-gl-js/v1.8.0/mapbox-gl.css', array(), '1.0', 'all');
